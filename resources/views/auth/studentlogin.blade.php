...
@section('content')
<div class="card">
    <div class="card-header text-center fs-4 fw-bold">{{ __('Student Login') }}</div>
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('student.login.submit') }}">
            ...
            <div class="row mb-3">
                <label for="rollnumber" class="col-md-4 col-form-label text-md-end d-none">{{ __('RollNumber') }}</label>
                <div class="col-md-12">
                    <input id="rollnumber" type="number" class="form-control @error('rollnumber') is-invalid @enderror" placeholder="{{ __('RollNumber') }}" name="rollnumber" value="{{ old('rollnumber') }}" required autocomplete="off" autofocus>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <a class="" href="{{ route('student.password.request') }}">
