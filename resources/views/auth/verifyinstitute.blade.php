...
@section('content')
    <!-- <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="d-inline" method="POST" action="{{ route('institute.verification.resend') }}">
                @csrf
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="d-inline" method="POST" action="{{ route('institute.verification.resend') }}">
                @csrf
                <button type="submit" class="btn btn-dark w-100 mb-0 align-baseline">{{ __('click here to request another') }}</button>
            </form>
        </div>
    </div>
@endsection
