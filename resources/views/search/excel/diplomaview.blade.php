            ...
            <div class="card border border-dark position-relative">
                <div>
                    <div class="position-absolute top-nv-13 d-flex gap-1">
                        ...
                        <div class="bg-black rounded text-white p-1 pb-0 border">{{ordinalget($searchinfo[2])}} Semester/Year</div>
                        ...
                        <thead class="table-dark">
                            <tr>
                                ...
                                @foreach($subjecthead as $subject)
                                    <th class="text-nowrap text-center align-content-center" colspan="2">{{$subject['code']}}</th>
                                @endforeach
                            </tr>
                            <tr>
                                @foreach($subjecthead as $subject)
