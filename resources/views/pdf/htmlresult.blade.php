...
<div class="pagebreak h-100 position-relative d-flex flex-column justify-content-between">
    <div class="d-block">
        <table class="px-5" style="width:100%; color:#008000;">
            <tbody>
                <tr>
                    <td style="text-align:left; border:0px;"><img src="{{asset('/assets/imgs/jnulogo.png')}}" style="width: 50%;" alt="JNU"></td>
                    ...
                    <td style="text-align:right; border:0px;"><img src="{{asset('/assets/imgs/logo.png')}}" style="width: 50%;" alt="NCHMCT" /></td>
                </tr>
                <tr>
        ...
        <div style="position:relative;">
            ...
            <div class="fw-bold" style="position:absolute; top:0; right:0;"><span style="color:#008000;">SL. No.</span><span style="color:black;">{{isset($result['data']['Stud_jnu_roll_number']) ? slnumber($result['data']['Stud_jnu_roll_number']) : ''}}</span></div>
        </div>
        ...
        <table style="width:100%; margin-top: 10px; text-align:center; border-collapse: collapse; border: 1px solid black;">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="border: 1px solid black; white-space: nowrap; padding:4px; font-weight:700;">{{isset($result['data']['Stud_jnu_roll_number']) ? $result['data']['Stud_jnu_roll_number'] : 'NCHMCT/BSC/2023/XXXXX'}}</td>
        ...
        <table style="width:100%; margin-top: 10px; border-collapse: collapse; text-align:center; border: 1px solid black;">
            ...
            <tbody>
                <tr>
                    <td style="border: 1px solid black; font-weight:700;">SEM-{{isset($result['data']['Stud_semester']) ? $result['data']['Stud_semester'] : 'X'}}</td>
        ...
        <table style="width:100%; margin-top: 10px; border-collapse: collapse; border: 1px solid black;">
            ...
            <tbody>
                ...
                <tr>
                    <td style="border: 1px solid black; font-weight:700; text-align:center; white-space: nowrap; text-transform: uppercase;">{{$single['coursecode'] ?? '--'}}</td>
                    <td style="border: 1px solid black; font-weight:700; text-align:left; white-space: nowrap;  padding: 4px 8px;  text-transform: capitalize;">{{$single['coursetitle'] ?? '--'}}</td>
                    <td style="border: 1px solid black; font-weight:700; text-align:center; white-space: nowrap; ">{{$single['coursecredit'] ?? '--'}}</td>
                    <td style="border: 1px solid black; font-weight:700; text-align:center; white-space: nowrap; ">{{$single['coursegrade'] ?? '--'}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <table style="width:100%; margin-top: 10px; border-collapse: collapse; border: 1px solid black;">
            ...
            <tbody>
                <tr>
                    <td style="border: 1px solid black; text-align:center; font-weight:700;">{{$result['currensemrecord']['totalcredit'] ?? '--'}}</td>
                    <td style="border: 1px solid black; text-align:center; font-weight:700;">{{$result['currensemrecord']['totalpoint'] ?? '--'}}</td>
                    <td style="border: 1px solid black; text-align:center; font-weight:700;">{{$result['data']['End_Result_SGPA'] ?? '--'}}</td>
                    <td style="border: 1px solid black; text-align:center; font-weight:700;">{{$result['cumulativerecord']['totalcredit'] ?? '--'}}</td>
                    <td style="border: 1px solid black; text-align:center; font-weight:700;">{{$result['cumulativerecord']['totalpoint'] ?? '--'}}</td>
                    <td style="border: 1px solid black; text-align:center; font-weight:700;">{{$result['data']['End_Result_CGPA'] ?? '--'}}</td>
                </tr>
            </tbody>
        </table>
...
<div class="pagebreak mt-5" style="background:white; font-size:x-small; position:relative;">
    <div>
        <table style="width:100%; border-collapse: collapse; border: 1px solid black;">
            <thead style="color:#008000;   border: 1px solid black;">
                ...
                <tr>
                    <td colspan="2" style="border: 1px solid black; padding:1px 6px; font-weight:700;">
        ...
        <div class="pt-3" style="color:#008000; font-weight:700;">
            <ul>
                <li>
    ...
    <div>
        <table style="width:100%; margin-top: 10px; border-collapse: collapse; border: 1px solid black;">
            ...
            <tbody style="color:#008000;  ">
                ...
                <tr>
                    <td style="text-align:left; padding:40px 20px 10px; border:0px;">Seal of Academic Chapter</td>
