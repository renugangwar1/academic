        ...
        <table>
            <tbody class="line-height-small">
                <tr>
                    ...
                    <td class="bold uppercase">{{ $singlecard['Institute_name'] }}</td>
                </tr>
                <tr>
                    <td><strong>COURSE:</strong></td>
                    <td class="bold uppercase">{{ $singlecard['Course_name'] }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="bold uppercase">{{ $singlecard['Student_name'] }}</td>
                </tr>
                <tr>
                    <td><strong>EXAM TYPE:</strong></td>
                    <td class="bold">{{ $singlecard['Exam_type'] }}</td>
                </tr>
                <tr>
                    <td><strong>ACADEMIC YEAR:</strong></td>
                    <td class="bold">{{ $singlecard['Academic_year'] }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="bold">{{ $singlecard['Date_of_issue'] }}</td>
                </tr>
                <tr>
                    <td><strong>APPEARING SUBJECTS:</strong></td>
                    <td class="bold">{{ $singlecard['Appear_subject'] }}</td>
                </tr>
            </tbody>
        </table>
